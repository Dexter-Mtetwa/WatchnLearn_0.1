...
import { ChevronLeft, ChevronDown, ChevronRight, CirclePlay as PlayCircle, FileText, CircleCheck as CheckCircle2, Download } from 'lucide-react-native';
...
export default function TermScreen() {
  const { termId, termName, subjectName, lastTopicId } = useLocalSearchParams();
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.title}>{termName}</Text>
        </View>
      </View>
